...
public class GovernmentAffairsListViewAdapter extends BaseAdapter {

    private LayoutInflater layoutInflater;
    private ArrayList<ListBeanMenu> listBeanMenus;

    public GovernmentAffairsListViewAdapter(Context context){
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.adapter_for_listview_governmentaffairs,parent,false);
            infoView.item = (TextView) convertView.findViewById(R.id.adp_for_lv_ga_tv);
