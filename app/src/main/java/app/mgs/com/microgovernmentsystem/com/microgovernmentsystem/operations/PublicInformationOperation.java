...
import app.mgs.com.microgovernmentsystem.com.microgovernmentsystem.tasks.PublicInformationWorkerTask;
import app.mgs.com.microgovernmentsystem.com.microgovernmentsystem.tools.GetSignTool;

/**
 * Created by Administrator on 2016/8/26.
 */
public class PublicInformationOperation {
    private Context mcontext;

    public PublicInformationOperation(Context context){
    ...
    public void SetPublicInformation(String id , final TaskWork taskWork){
        new PublicInformationWorkerTask(new PublicInformationWorkerTask.AsyncWork() {
...
//                progressDialog.setTitle("正在加载公共信息内容，请稍候...");
