...
public class PublicInformationListSelectAdapter extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private ArrayList<ListBeanSelect> listBeanSelects;

    public PublicInformationListSelectAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.adapter_for_listview_public_information_list_select,parent,false);
            infoView.tvContent = (TextView) convertView.findViewById(R.id.adp_for_lv_public_information_list_select_tv);
            infoView.ibtSelect = (ImageButton) convertView.findViewById(R.id.adp_for_lv_public_information_list_select_ibt);
