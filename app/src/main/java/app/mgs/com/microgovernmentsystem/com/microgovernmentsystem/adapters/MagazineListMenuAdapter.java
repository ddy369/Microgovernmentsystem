...
public class MagazineListMenuAdapter extends BaseAdapter {

    private LayoutInflater layoutInflater;
    private ArrayList<ListBeanMenu> listBeanMenus;

    public MagazineListMenuAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.adapter_for_listview_magazine_list_menu,parent,false);
            infoView.item = (TextView) convertView.findViewById(R.id.adp_for_lv_magazine_list_menu_tv);
