...
public class MailListSelectAdapter extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private ArrayList<ListBeanSelect> listBeanSelects;

    public MailListSelectAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        final InfoViewSelect infoView;
        if (convertView == null) {
            infoView = new InfoViewSelect();
            convertView = layoutInflater.inflate(R.layout.adapter_for_listview_mail_list_select,parent,false);
            infoView.tvContent = (TextView) convertView.findViewById(R.id.adp_for_lv_mail_list_select_tv);
            infoView.ibtSelect = (ImageButton) convertView.findViewById(R.id.adp_for_lv_mail_list_select_ibt);
