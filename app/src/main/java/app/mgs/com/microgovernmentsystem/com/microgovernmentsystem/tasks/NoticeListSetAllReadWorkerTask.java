...
public class NoticeListSetAllReadWorkerTask extends AsyncTask<String, Integer, Integer> {
    //开启一个异步任务进行联网登录的处理
    ...
    public NoticeListSetAllReadWorkerTask(AsyncWork asyncWork) {
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            String address = Values.ServerAddress+"/SetInformationRead";
