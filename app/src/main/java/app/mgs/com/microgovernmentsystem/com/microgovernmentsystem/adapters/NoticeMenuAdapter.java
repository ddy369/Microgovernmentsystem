...
public class NoticeMenuAdapter extends BaseAdapter {
    ...
    public NoticeMenuAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.adapter_for_listview_notice_menu,parent,false);
            infoView.item = (TextView) convertView.findViewById(R.id.adp_for_lv_notice_menu_tv);
