...
public class DepartmentInformationListSelectDepartmentAdapter extends BaseAdapter{
    private LayoutInflater layoutInflater;
    private ArrayList<ListBeanSelect> listBeanSelects;

    public DepartmentInformationListSelectDepartmentAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate
                    (R.layout.adapter_for_listview_department_information_list_select_department,parent,false);
            infoView.tvContent = (TextView) convertView.findViewById
                    (R.id.adp_for_lv_department_information_list_select_department_tv);
            infoView.ibtSelect = (ImageButton) convertView.findViewById
                    (R.id.adp_for_lv_department_information_list_select_department_ibt);
